		...
		<div class="well" style="position:relative;top:20vh;">
			<form class="form-horizontal form-custom-login" action="" method="POST">
			  <div class="form-heading" style="background: orange;">
			    <h2 class="text-center">Porfavor cambie su contraseña</h2>
			  </div>
			  ...
			  <button type="submit" name="change_password_btn" class="btn btn-default pull-right">Cambiar la contraseña</button>
			</form>
		</div>
	</div>
</div>
