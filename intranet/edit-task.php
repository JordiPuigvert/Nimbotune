        ...
        <div class="well well-custom">
          <div class="row">
            <div class="col-md-8 col-md-offset-2">
              <div class="well">
                <h3 class="text-center bg-primary" style="padding: 7px;">Editar tarea </h3><br>

                      <div class="row">
                        <div class="col-md-12">
                          <form class="form-horizontal" role="form" action="" method="post" autocomplete="off">
                            <div class="form-group">
			                    <label class="control-label col-sm-5">Título de la tarea</label>
			                    <div class="col-sm-7">
			                  ...
			                  <div class="form-group">
			                    <label class="control-label col-sm-5">Descripcón de la tarea</label>
			                    <div class="col-sm-7">
			                  ...
			                  <div class="form-group">
			                    <label class="control-label col-sm-5">Hora de inicio</label>
			                    <div class="col-sm-7">
			                      <input type="text" name="t_start_time" id="t_start_time"  class="form-control" value="<?php echo $row['t_start_time']; ?>">
			                    </div>
			                  </div>
			                  <div class="form-group">
			                    <label class="control-label col-sm-5">Hora de finalización</label>
			                    <div class="col-sm-7">
			                  ...
			                  <div class="form-group">
			                    <label class="control-label col-sm-5">Asignar a</label>
			                    <div class="col-sm-7">
			                      <?php 
			                   ...
			                   <div class="form-group">
			                    ...
			                    <div class="col-sm-7">
			                      <select class="form-control" name="status" id="status">
			                      	...
			                      	<option value="1" <?php if($row['status'] == 1){ ?>selected <?php } ?>>En progreso</option>
			                      	<option value="2" <?php if($row['status'] == 2){ ?>selected <?php } ?>>Completado</option>
			                      </select>
			                    </div>
			                  </div>
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-3">
                                <button type="submit" name="update_task_info" class="btn btn-success-custom">Actualizar ahora</button>
                              </div>
                            </div>
                          </form> 
                        </div>
