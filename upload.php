          ...
          <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
              <ul class="navbar-nav">
                ...
                <li class="nav-item">
                  <a class="nav-link active" href="music.php">Música</a>
                </li>
                <ul class="navbar-nav">
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="form.html">Contáctanos</a>
                  </li>
                <li class="nav-item">
...
<form style="left: 60%; top: 90%; margin-left: -25%; position: absolute; margin-top: -25%; " action="uploaded.php" method="POST" enctype="multipart/form-data">
<input style="color: #FF2A00" type="file" name="audioFile" accept="audio/*"/>
<input  type="submit" value="Subir audio" name="save_audio" />
</form>
